...
Example usage:
    python create_tf_record.py --data_dir --output_dir
"""
import hashlib
import io
import logging
...
import sys
BASE_DIR = "/home/nishiyama/models-master/research"
...
def create_tf_record(output_filename,
  ...
  for idx, example in enumerate(examples):
    ...
    try:
      tf_example = dict_to_tf_example(data, label_map_dict, image_dir, faces_only=faces_only)
...
def main(_):
  ...
  num_train = int(0.7 * num_examples) #Holdout
